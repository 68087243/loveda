...
<div class="container" style="margin-top: 30px;padding: 0 0 50px 0 ;">
    <div class="fl column" style="width: 910px;">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td> <a href="/index/rkinfo.html?id=<?php echo ($vo["tid"]); ?>"  class="clo6"><span style="display: inline-block;width: 10px;height: 10px;border-radius: 10px;;" class="bgy"></span>&nbsp;&nbsp;<?php echo ($vo['title']); ?></a></td>
                <td></td>
                <td><?php echo timeTran($vo['createtime']);?></td>
...
<script>
    $(function () {
        getMask().maskShow({"tit": "发布需求","width":500, "cont": "#rkbox"});
    })
    function sub(){
