                    ...
                    <div class="fl profile-img-links pull-left" style="width: 167px">
                        <div class="relative inline search-thumb-container tc light-bg">
                            ...
                            <a href="/index/uinfo.html?uid=<?php echo ($vo["uid"]); ?>">
                                <img alt="按一下了解简介详细资料" width="140px;" title=": 按一下了解简介详细资料" src="http://www.adsvip.cn/Public<?php echo ((isset($vo["picture"]) && ($vo["picture"] !== ""))?($vo["picture"]):'/static/image/noavatar_middle.gif'); ?>" class="search-thumb middle" data-toggle="tooltip" data-placement="right">
                            </a>
                        </div>
                    </div>
