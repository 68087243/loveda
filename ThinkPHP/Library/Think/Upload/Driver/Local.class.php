...
class Local{
    ...
    public function ishtml5(){
    	return isset($_SERVER['HTTP_CONTENT_DISPOSITION'])&&preg_match('/attachment;\s+name="(.+?)";\s+filename="(.+?)"/i',$_SERVER['HTTP_CONTENT_DISPOSITION'],$info);
    }
    /**
     * 保存指定文件
