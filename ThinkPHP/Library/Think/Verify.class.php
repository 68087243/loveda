...
class Verify {
	public $seKey     = 'verifycode.com'; //验证码加密密钥
	 ...
	 * @var string
	 */
	private $_codeSet = '0123456789';//'2345678abcdefhijkmnpqrstuvwxyzABCDEFGHJKLMNPQRTUVWXY';
	...
	public function entry($id = '') {
		...
		for ($i = 0; $i<$this->length; $i++) {
			if($this->useZh) {
				...
				// 写一个验证码字符
				$this->useZh || imagettftext($this->_image, $this->fontSize*1.5, mt_rand(-40, 40), $codeNX, $this->fontSize*1.6, $this->_color, $this->fontttf, $code[$i]);
			}
		}
